  ...
  return (
    <>
            ...
            <Grid item key={card} xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                    This is a media card, This section describes the content
                  </Typography>
                </CardContent>
                <CardActions>
      ...
      <footer className={classes.footer}>
        ...
        <Typography variant="subtitle1" align="center" color="textSecondary">Something here for a footer purpose</Typography>
      </footer>
  </>
  )
}
